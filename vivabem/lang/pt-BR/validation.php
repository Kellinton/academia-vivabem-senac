...
return [
    ...
    | a classe de validação. Algumas dessas regras têm várias versões, como
    ...
    */
    ...
    | convenção "attribute.rule" para nomear as linhas. Isso facilita
    | especificar uma mensagem de idioma específica para uma regra de atributo específica.
    |
    */
