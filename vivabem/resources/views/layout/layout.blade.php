            ...
            <div class="widget footer-widget">
                <div class="widget-about">
                    <div class="footer-logo">
                        <a href="{{ url('/') }}"><img src="{{ asset('img/logo-white.svg') }}" alt="VivaBem"></a>
                    </div>
    ...
    <div class="mobile-menu-wrapper">
        <div class="mobile-menu-area text-center">
            ...
            <div class="mobile-logo">
                <a href="{{ url('/') }}"><img src="{{ asset('img/logo.svg') }}" alt="Fitmas"></a>
            </div>
            <div class="mobile-menu">
                <ul>
                    ...
                    <li class="menu-item-has-children">
                        <a href="#">Service</a>
                        <ul class="sub-menu">
                            <li><a href="{{ url('/project-details') }}">Service</a></li>
                            <li><a href="{{ url('/modalidades') }}">Service Details</a></li>
                        </ul>
                    </li>
                    <li class="menu-item-has-children">
                        <a href="#">Blog</a>
                    ...
                    <div class="row align-items-center justify-content-lg-start justify-content-between">
                        <div class="col-auto">
                            <div class="header-logo">
                                <a href="{{ url('/') }}"><img src="{{ asset('img/logo-white.svg') }}" alt="logo"></a>
                            </div>
                        </div>
                ...
                <div class="row justify-content-between">
                    <div class="col-md-6 col-xl-3">
                        <div class="widget footer-widget">
                            <div class="widget-about">
                                <div class="footer-logo">
                                    <a href="{{ url('/') }}"><img src="{{ asset('img/logo-white.svg') }}" alt="Fitmas"></a>
                                </div>
                    ...
                    <div class="col-md-6 col-xl-3">
                        <div class="widget footer-widget">
                            ...
                            <form action="{{ route('contato.enviarnew') }}" method="POST" class="newsletter-form" id="newsForm">
                                <div class="form-group">
                                    <i class="far fa-envelope"></i>
                                    <input class="form-control" type="email" placeholder="Endereço de e-mail" value="{{ old('emailNewsletter') }}" required="" id="emailNewsletter">
                                    <div id="emailNewsletterError" class="error-mensagem"></div>
                                </div>
                                <button type="submit" class="btn style-r0 style2" onclick="newsForm(event)">Inscrever-se</button>
                                <div id="newsletterMensagem" class="msgNewsletter"></div>
                            </form>
                        </div>
                    </div>
                </div>
