                        ...
                        <div class="col-xl-6 col-lg-7 col-md-9">
                            <div class="hero-style2">
                                ...
                                <div class="btn-group" data-ani="slideinup" data-ani-delay="0.3s">
                                    <a href="{{ url('/contato') }}" class="btn style-r0 style2">Marcar Consulta</a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row global-carousel service-slider-1 style2" data-slide-show="4" data-ml-slide-show="3" data-lg-slide-show="3" data-md-slide-show="2" data-sm-slide-show="1" data-xs-slide-show="1" data-dots="false">
                    <div class="col-lg-4 col-md-6">
                        <div class="service-card">
                            ...
                            <div class="service-card_content">
                                ...
                                <a href="{{ url('/modalidade/musculacao') }}" class="link-btn" tabindex="0">Ler Mais<i class="fas fa-arrow-right"></i></a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="service-card">
                            ...
                            <div class="service-card_content">
                                <h4 class="service-card_title h5"><a href="{{ url('/modalidade.aerobica') }}">Aerobica</a></h4>
                                <p class="service-card_text">Lacinia montes est odio tpor volutpat rhoncus quisque sagittis</p>
                                <a href="{{ url('/modalidade.aerobica') }}" class="link-btn" tabindex="0">Ler Mais<i class="fas fa-arrow-right"></i></a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="service-card">
                            ...
                            <div class="service-card_content">
                                <h4 class="service-card_title h5"><a href="{{ url('modalidade/alongamento-flexibilidade') }}">Alongamento e Flexibilidade</a></h4>
                                <p class="service-card_text">Lacinia montes est odio tpor volutpat rhoncus quisque sagittis</p>
                                <a href="{{ url('modalidade/alongamento-flexibilidade') }}" class="link-btn" tabindex="0">Ler Mais<i class="fas fa-arrow-right"></i></a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="service-card">
                            ...
                            <div class="service-card_content">
                                <h4 class="service-card_title h5"><a href="{{ url('/modalidade/artes-marciais') }}">Artes Marciais</a></h4>
                                <p class="service-card_text">Lacinia montes est odio tpor volutpat rhoncus quisque sagittis</p>
                                <a href="{{ url('/modalidade/artes-marciais') }}" class="link-btn" tabindex="0">Ler Mais<i class="fas fa-arrow-right"></i></a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="service-card">
                            ...
                            <div class="service-card_content">
                                <h4 class="service-card_title h5"><a href="{{ url('/modalidade/natacao') }}">Natação</a></h4>
                                <p class="service-card_text">Lacinia montes est odio tpor volutpat rhoncus quisque sagittis</p>
                                <a href="{{ url('/modalidade/natacao') }}" class="link-btn" tabindex="0">Ler Mais<i class="fas fa-arrow-right"></i></a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="service-card">
                            ...
                            <div class="service-card_content">
                                <h4 class="service-card_title h5"><a href="{{ url('/modalidade/pilates') }}">Pilates</a></h4>
                                <p class="service-card_text">Lacinia montes est odio tpor volutpat rhoncus quisque sagittis</p>
                                <a href="{{ url('/modalidade/pilates') }}" class="link-btn" tabindex="0">Ler Mais<i class="fas fa-arrow-right"></i></a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="service-card">
                            ...
                            <div class="service-card_content">
                                <h4 class="service-card_title h5"><a href="{{ url('/modalidade/treinamento-funcional') }}">Treinamento Funcional</a></h4>
                                <p class="service-card_text">Lacinia montes est odio tpor volutpat rhoncus quisque sagittis</p>
                                <a href="{{ url('/modalidade/treinamento-funcional') }}" class="link-btn" tabindex="0">Ler Mais<i class="fas fa-arrow-right"></i></a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="service-card">
                            ...
                            <div class="service-card_content">
                                <h4 class="service-card_title h5"><a href="{{ url('/modalidade/treino-cardiovascular') }}">Treino Cardiovascular</a></h4>
                                <p class="service-card_text">Lacinia montes est odio tpor volutpat rhoncus quisque sagittis</p>
                                <a href="{{ url('/modalidade/treino-cardiovascular') }}" class="link-btn" tabindex="0">Leia Mais<i class="fas fa-arrow-right"></i></a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="service-card">
                            ...
                            <div class="service-card_content">
                                <h4 class="service-card_title h5"><a href="{{ url('/modalidade/zumba') }}">Zumba</a></h4>
                                <p class="service-card_text">Lacinia montes est odio tpor volutpat rhoncus quisque sagittis</p>
                                <a href="{{ url('/modalidade/zumba') }}" class="link-btn" tabindex="0">Leia Mais<i class="fas fa-arrow-right"></i></a>
                            </div>
                        </div>
                    </div>
        ...
        <div class="container container2">
            <div class="row">
                ...
                <div class="col-lg-6 order-lg-1">
                    <div class="title-area">
                        <span class="sub-title">Objetivo da Fitmas</span>
                        <h2 class="sec-title fw-semibold">LIBERTE SEU PLENO POTENCIAL, ALCANCE SEUS OBJETIVOS FITNESS.</h2>
                    </div>
                    <div class="goal-grid-wrap">
                        <div class="about-grid style3">
                            ...
                            <div class="about-grid_content">
                                <h4 class="about-grid_title">Treinamento Fitness Gratuito</h4>
                                <p class="about-grid_text">Pedale até a forma física em nosso estúdio de ciclismo indoor especializado. Equipado com bicicletas estacionárias...</p>
                            </div>
                        </div>
                        <div class="about-grid style3">
                            <div class="about-grid_icon">
                        ...
                        <div class="btn-wrap">
                            <a class="btn style-r0" href="{{ url('/modalidade') }}">Saiba Mais</a>
                            <a class="btn btn-border style-r0" href="{{ url('/modalidade') }}">Ver Todos os Serviços</a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-xl-4 col-lg-5 col-md-6 position-relative">
                    <div class="blog_sec_title_static me-lg-3">
                        <div class="blog_sec_title_wrap">
                            ...
                            <a class="btn style-r0" href="{{ url('/blog') }}">Ver Mais Posts</a>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="blog-card style2">
                        ...
                        <div class="blog-content">
                            ...
                            <h3 class="blog-title box-title"><a href="{{ url('/blog-details') }}">Dominando as Máquinas: Um Guia para Iniciantes
                                sobre Equipamentos de Academia</a></h3>
                            <a href="{{ url('/blog-detalhes') }}" class="link-btn style2"><i class="fas fa-arrow-right"></i> LEIA MAIS</a>
                        </div>
                    </div>
                </div>
            </div>
