...
@section('conteudo')
    ...
    <div class="hero-wrapper hero-1" id="hero">
        <div class="global-carousel" id="heroSlider1" data-fade="true" data-slide-show="1" data-lg-slide-show="1" data-md-slide-show="1" data-sm-slide-show="1" data-xs-slide-show="1" data-arrows="true" data-xl-arrows="true" data-ml-arrows="true">
            <div class="hero-slider" data-bg-src="{{ asset('img/hero/hero_bg_1_1.png') }}">
                    ...
                    <div class="row">
                        <div class="col-xl-6 col-lg-7 col-md-9">
                            <div class="hero-style1">
                                <span class="hero-subtitle" data-ani="slideinup" data-ani-delay="0s">Bem-vindo à nossa academia</span>
                                <h1 class="hero-title text-white" data-ani="slideinup" data-ani-delay="0.1s">A melhor
                                    <span>Academia</span>
                                    da cidade</h1>
                                <div class="btn-group" data-ani="slideinup" data-ani-delay="0.2s">
                                    <a href="{{ url('contact.blade.php') }}" class="btn style2">Marcar Consulta</a>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="hero-slider" data-bg-src="{{ asset('img/hero/hero_bg_1_2.png') }}">
                <div class="hero-shape1 shape-mockup movingX" data-bottom="165px" data-right="0">
                    <img src="{{ asset('img/hero/hero_shape_1.png') }}" alt="img">
                </div>
                <div class="container">
                    <div class="row">
                        <div class="col-xl-6 col-lg-7 col-md-9">
                            <div class="hero-style1">
                                <span class="hero-subtitle" data-ani="slideinup" data-ani-delay="0s">Welcome To Our Company</span>
                ...
                <div class="row gx-0">
                    <div class="col-lg-4">
                        <div class="feature-card">
                            <div class="feature-card_bg">
                                <img src="{{ asset('img/bg/feature-card_bg1.png') }}" alt="img">
                            </div>
                            <div class="feature-card_icon">
                                <img src="{{ asset('img/icon/feature-icon1-1.svg') }}" alt="img">
                            </div>
                            <h6 class="feature-card_subtitle">Healthier Life</h6>
                            <h4 class="feature-card_title"><a href="service-details.html">Achieve Your Goals</a></h4>
                            <p class="feature-card_text">We believe that with the right guidance, support, and mindset, you can accomplish anything you set your mind to.</p>
                    ...
                    <div class="col-lg-4">
                        <div class="feature-card feature-card-active">
                            ...
                            <div class="feature-card_icon">
                                <img src="{{ asset('img/icon/feature-icon1-2.svg') }}" alt="img">
                            </div>
                            <h6 class="feature-card_subtitle">Healthier Life</h6>
                            <h4 class="feature-card_title"><a href="service-details.html">Best Institute Certificate</a></h4>
                            <p class="feature-card_text">We believe that with the right guidance, support, and mindset, you can accomplish anything you set your mind to.</p>
                            <a href="contact.html" class="btn style2">View Class Schedule</a>
                        </div>
                    </div>
                    <div class="col-lg-4">
                        <div class="feature-card">
                            ...
                            <div class="feature-card_icon">
                                <img src="{{ asset('img/icon/feature-icon1-3.svg') }}" alt="img">
                            </div>
                            <h6 class="feature-card_subtitle">Healthier Life</h6>
                            <h4 class="feature-card_title"><a href="service-details.html">Train Day and Night</a></h4>
                            <p class="feature-card_text">We believe that with the right guidance, support, and mindset, you can accomplish anything you set your mind to.</p>
                            <a href="contact.html" class="btn style2">View Class Schedule</a>
                        </div>
                    </div>
    ...
    Service Area
    ==============================-->
    <div class="service-bg-area" data-bg-src="{{ asset('img/bg/service-bg.png') }}">
        <div class="sec-shape-top">
            <img src="{{ asset('img/bg/sec-shape-top.png') }}" alt="img">
        </div>
        <!--==============================
        Service Area 01
        ==============================-->
            ...
            <div class="container-fluid p-0">
                <div class="row global-carousel service-slider-1" data-slide-show="4" data-ml-slide-show="3" data-lg-slide-show="3" data-md-slide-show="2" data-sm-slide-show="1" data-xs-slide-show="1" data-dots="false">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="service-card">
                            <div class="service-card_icon">
                                <img src="{{ asset('img/icon/service-icon_1-1.svg') }}/img/icon/service-icon_1-2.svg" alt="img">
                            </div>
                            <div class="service-card_content">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="service-card">
                            <div class="service-card_icon">
                                <img src="{{ asset('img/icon/service-icon_1-1.svg') }}/img/icon/service-icon_1-3.svg" alt="img">
                            </div>
                            <div class="service-card_content">
        ...
        <div class="wcu-area-1 space-bottom">
            <div class="container">
                <div class="row">
                    <div class="col-lg-6">
                        <div class="wcu-thumb">
                            <img class="img-1" src="{{ asset('') }}/img/normal/wcu_1-2.png" alt="img">
                            <div class="img-2 jump">
                                <img src="{{ asset('') }}/img/normal/wcu_1-1.png" alt="img">
                            </div>
                    ...
                    <div class="col-lg-6">
                        <div class="wcu-wrap">
                            <div class="title-area mb-50">
                                ...
                                <p class="sec-text text-white">Sed ut perspiciatis unde omnis iste natus voluptatem accusantium dolore mque laudantium aperiam eaquecy inventore veritatis</p>
                            </div>
                            <div class="accordion-area accordion" id="faqAccordion">
                                ...
                                <div class="accordion-card active">
                                    ...
                                    <div id="collapse-1" class="accordion-collapse collapse show" aria-labelledby="collapse-item-1" data-bs-parent="#faqAccordion">
                                        <div class="accordion-body">
                                            <p class="faq-text">Our standard membership provides access to our gym facilities during regular operating hours. This option is ideal for individuals who prefer independent workouts and want to make use of our state</p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="accordion-card ">
                                    ...
                                    <div id="collapse-2" class="accordion-collapse collapse " aria-labelledby="collapse-item-2" data-bs-parent="#faqAccordion">
                                        <div class="accordion-body">
                                            <p class="faq-text">Professionally are many variations of passages the majority have suffered alteration in some fo injected humour, or randomised words believable.</p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="accordion-card ">
                                    ...
                                    <div id="collapse-3" class="accordion-collapse collapse " aria-labelledby="collapse-item-3" data-bs-parent="#faqAccordion">
                                        <div class="accordion-body">
                                            <p class="faq-text">Contributors are many variations of passages the majority have suffered alteration in some fo injected humour, or randomised words believable.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
        ...
        <div class="sec-shape-bottom">
            <img src="{{ asset('') }}/img/bg/sec-shape-bottom.png" alt="img">
        </div>
    </div>
    ...
    Counter Area
    ==============================-->
    <div class="counter-area-1" data-bg-src="{{ asset('') }}/img/bg/counter-bg1.png">
            ...
            <div class="container">
                <div class="row gy-40 justify-content-between">
                    <div class="col-sm-6 col-xl-auto">
                        <div class="counter-card">
                            <div class="counter-card_icon">
                                <img src="{{ asset('') }}/img/icon/counter-icon_1-1.svg" alt="icon">
                            </div>
                    ...
                    <div class="col-sm-6 col-xl-auto">
                        <div class="counter-card">
                            <div class="counter-card_icon">
                                <img src="{{ asset('') }}/img/icon/counter-icon_1-2.svg" alt="icon">
                            </div>
                            <div class="media-body">
                    ...
                    <div class="col-sm-6 col-xl-auto">
                        <div class="counter-card">
                            <div class="counter-card_icon">
                                <img src="{{ asset('') }}/img/icon/counter-icon_1-3.svg" alt="icon">
                            </div>
                            <div class="media-body">
                    ...
                    <div class="col-sm-6 col-xl-auto">
                        <div class="counter-card">
                            <div class="counter-card_icon">
                                <img src="{{ asset('') }}/img/icon/counter-icon_1-4.svg" alt="icon">
                            </div>
                            <div class="media-body">
    ...
    <div class="testimonial-area-1 overflow-hidden">
        <div class="testimonial-bg-thumb1">
            <div class="thumb">
                <img src="{{ asset('') }}/img/testimonial/testi_bg1.png" alt="img">
            </div>
        </div>
        <div class="space">
            <div class="container">
                <div class="row justify-content-end">
                    <div class="col-xl-8 col-lg-9">
                        <div class="testi-box-wrap1 text-center" data-bg-src="{{ asset('') }}/img/testimonial/testi_box-bg.png">
                            <div class="title-area">
                            ...
                            <div class="row global-carousel testi-slider-1" data-slide-show="1">
                                <div class="col-lg-6">
                                    <div class="testi-box">
                                        <div class="testi-box_thumb">
                                            <img src="{{ asset('') }}/img/testimonial/testi_1_1.png" alt="img">
                                            <div class="block-quote">
                                                <i class="fas fa-quote-right"></i>
                                            </div>
                                        </div>
                                        <div class="testi-box_content">
                                            <p class="testi-box_text">“I have been a member of Fitmas for over a year now, and it has been a game-changer for my fitness journey. The gym has a fantastic range of equipment that caters to all my workout needs....”</p>
                                            <div class="rating">
                                ...
                                <div class="col-lg-6">
                                    <div class="testi-box">
                                        <div class="testi-box_thumb">
                                            <img src="{{ asset('') }}/img/testimonial/testi_1_2.png" alt="img">
                                            <div class="block-quote">
                                                <i class="fas fa-quote-right"></i>
                                            </div>
                                        </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="testi-box">
                                        <div class="testi-box_thumb">
                                            <img src="{{ asset('') }}/img/testimonial/testi_1_3.png" alt="img">
                                            <div class="block-quote">
                                                <i class="fas fa-quote-right"></i>
                                            </div>
                                        </div>
            ...
            <div class="row">
                <div class="col-lg-6 order-lg-2 text-lg-end">
                    <div class="goal-thumb-1 mb-40 mb-lg-0">
                        <img src="{{ asset('') }}/img/normal/goal_1-1.png" alt="img">
                        <div class="goal-badge-wrap">
                            <div class="goal-badge">We Have Train More Than  <span class="counter-number">1580</span>+ Students</div>
                        </div>
                    </div>
                </div>
