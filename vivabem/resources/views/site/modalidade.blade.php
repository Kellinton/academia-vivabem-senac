                ...
                <div class="col-md-6 col-lg-4">
                    <div class="blog-card">
                        ...
                        <div class="blog-content" data-bg-src="{{ asset('img/blog/blog_card1_bg.png') }}">
                            ...
                            <h3 class="blog-title box-title"><a href="{{ url('/musculacao') }}">Musculação</a></h3>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="blog-card">
                        ...
                        <div class="blog-content" data-bg-src="{{ asset('img/blog/blog_card1_bg.png') }}">
                            ...
                            <h3 class="blog-title box-title"><a href="{{ url('/aerobica') }}">Aeróbica</a></h3>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="blog-card">
                        ...
                        <div class="blog-content" data-bg-src="{{ asset('img/blog/blog_card1_bg.png') }}">
                            ...
                            <h3 class="blog-title box-title"><a href="{{ url('/pilates') }}">Pilates</a></h3>
                            <p class="blog-text">
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="blog-card">
                        ...
                        <div class="blog-content" data-bg-src="{{ asset('img/blog/blog_card1_bg.png') }}">
                            ...
                            <h3 class="blog-title box-title"><a href="{{ url('/yoga') }}">Yoga</a></h3>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="blog-card">
                        ...
                        <div class="blog-content" data-bg-src="{{ asset('img/blog/blog_card1_bg.png') }}">
                            ...
                            <h3 class="blog-title box-title"><a href="{{ url('/pilates') }}">Treinamento Funcional</a></h3>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="blog-card">
                        ...
                        <div class="blog-content" data-bg-src="{{ asset('img/blog/blog_card1_bg.png') }}">
                            ...
                            <h3 class="blog-title box-title"><a href="{{ url('/zumba') }}">Zumba</a></h3>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="blog-card">
                        ...
                        <div class="blog-content" data-bg-src="{{ asset('img/blog/blog_card1_bg.png') }}">
                            ...
                            <h3 class="blog-title box-title"><a href="{{ url('/natacao') }}">Natação</a></h3>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="blog-card">
                        ...
                        <div class="blog-content" data-bg-src="{{ asset('img/blog/blog_card1_bg.png') }}">
                            ...
                            <h3 class="blog-title box-title"><a href="{{ url('/artes-marciais') }}">Artes Marciais</a></h3>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="blog-card">
                        ...
                        <div class="blog-content" data-bg-src="{{ asset('img/blog/blog_card1_bg.png') }}">
                            ...
                            <h3 class="blog-title box-title"><a href="{{ url('/alongamento-flexibilidade') }}">Alongamento e Flexibilidade</a></h3>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="blog-card">
                        ...
                        <div class="blog-content" data-bg-src="{{ asset('img/blog/blog_card1_bg.png') }}">
                            ...
                            <h3 class="blog-title box-title"><a href="{{ url('/treino-cardiovascular') }}">Treino Cardiovascular</a></h3>
