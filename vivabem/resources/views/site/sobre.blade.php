                ...
                <div class="col-lg-6 order-lg-1">
                    <div class="about-content-wrap">
                        <div class="title-area mb-0">
                            ...
                            <p class="sec-text">Bem-vindo ao Vivabem. seu destino final para alcançar seus objetivos de condicionamento físico. Compreendemos a importância de levar um estilo de vida saudável e oferecemos instalações de fitness de alto nível para apoiá-lo em sua jornada de fitness.
                            </p>
                        ...
                        <div class="btn-wrap mt-40">
                            <a href="{{ url('/sobre') }}" class="btn">Marcar uma consulta</a>
            ...
            <div class="row global-carousel service-slider-2 slider-shadow" data-slide-show="3" data-ml-slide-show="3" data-lg-slide-show="3" data-md-slide-show="2" data-sm-slide-show="1" data-xs-slide-show="1" data-dots="false">
                <div class="col-lg-4 col-md-6">
                    <div class="service-card style2">
                        ...
                        <div class="service-card_content">
                            <h4 class="service-card_title h5"><a href="{{ url('/service-details') }}">Aula de ginástica</a></h4>
                            <p class="service-card_text">Treinos de alta intensidade que alternam entre rajadas intensas de exercício e curtos períodos de recuperação...</p>
                            <a href="{{ url('/servico-detalhes') }}" class="link-btn" tabindex="0"><i class="fas fa-arrow-right"></i>Consulte mais informações</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6">
                    <div class="service-card style2">
                        ...
                        <div class="service-card_content">
                            <h4 class="service-card_title h5"><a href="{{ url('/servico-detalhes') }}">Levantamento de força</a></h4>
                            <p class="service-card_text">Treinos de alta intensidade que alternam entre rajadas intensas de exercício e curtos períodos de recuperação...</p>
                            <a href="{{ url('/servico-detalhes') }}" class="link-btn" tabindex="0"><i class="fas fa-arrow-right"></i>Consulte mais informações</a>
                        </div>
                    </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="service-card style2">
                        ...
                        <div class="service-card_content">
                            <h4 class="service-card_title h5"><a href="{{ url('/servico-detalhes') }}">Musculação</a></h4>
                            <p class="service-card_text">Treinos de alta intensidade que alternam entre rajadas intensas de exercício e curtos períodos de recuperação...</p>
                            <a href="{{ url('/servico-detalhes') }}" class="link-btn" tabindex="0"><i class="fas fa-arrow-right"></i>Consulte mais informações</a>
                        </div>
                    </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="service-card style2">
                        ...
                        <div class="service-card_content">
                            <h4 class="service-card_title h5"><a href="{{ url('/servico-detalhes') }}">Aula de ginástica</a></h4>
                            <p class="service-card_text">Treinos de alta intensidade que alternam entre rajadas intensas de exercício e curtos períodos de recuperação...</p>
                            <a href="{{ url('/servico-detalhes') }}" class="link-btn" tabindex="0"><i class="fas fa-arrow-right"></i>Consulte mais informações</a>
                        </div>
                    </div>
            ...
            <div class="row justify-content-lg-end justify-content-center">
                <div class="col-xl-6 col-lg-8 col-md-10">
                    <div class="cta-wrap text-center text-lg-start">
                        ...
                        <div class="btn-wrap mt-40">
                            <a href="{{ url('/sobre') }}" class="btn style2">Marque uma consulta</a>
            ...
            <div class="row global-carousel team-slider-1 slider-shadow" data-slide-show="4" data-ml-slide-show="4" data-lg-slide-show="3" data-md-slide-show="2" data-sm-slide-show="1" data-xs-slide-show="1" data-center-mode="true">
                <div class="col-lg-4 col-md-6">
                    <div class="team-card">
                        ...
                        <div class="team-card_content">
                            <h4 class="team-card_title"><a href="{{ url('/equipe-detalhes') }}">George Thomas</a>
                            </h4>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="team-card">
                        ...
                        <div class="team-card_content">
                            <h4 class="team-card_title"><a href="{{ url('/equipe-detalhes') }}">Mike Johnson</a>
                            </h4>
                            <span class="team-card_desig">CEO e Fundador</span>
                            <div class="social-btn">
                                <a href="https://twitter.com/"><i class="fab fa-twitter"></i></a>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="team-card">
                        ...
                        <div class="team-card_content">
                            <h4 class="team-card_title"><a href="{{ url('/equipe-detalhes') }}">Amelia Harper</a>
                            </h4>
                            <span class="team-card_desig">CEO e Fundador</span>
                            <div class="social-btn">
                                <a href="https://twitter.com/"><i class="fab fa-twitter"></i></a>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="team-card">
                        ...
                        <div class="team-card_content">
                            <h4 class="team-card_title"><a href="{{ url('/equipe-detalhes') }}">Oliver Samuel</a>
                            </h4>
                            <span class="team-card_desig">CEO e Fundador</span>
                            <div class="social-btn">
                                <a href="https://twitter.com/"><i class="fab fa-twitter"></i></a>
